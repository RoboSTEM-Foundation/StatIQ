        ...
        child: Column(
          ...
          children: [
            ...
            _buildCreditCard(context,
              name: 'alex',
              handle: '@1698v now @60666x',
              description: 'Thanks for providing a 2nd API key and the opportunity for me to develop this app for RoboStem Inc',
              icon: Icons.api,
            ...
            _buildCreditCard(context,
              name: 'jason',
              handle: '@2982_x',
              description: 'Thanks for considering my request taking the risk and giving me a shot along with asking alex to let me develop this app',
